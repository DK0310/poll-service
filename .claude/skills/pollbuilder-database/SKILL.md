...
This skill holds **reusable EF Core 8 + SQL Server patterns**: how to model entities, configure a DbContext, run per-service migrations, write efficient queries, and choose indexes.
